...
public:
    ...
    uint32 GetTotalReports(uint32 guidLow);
    float GetAverage(uint32 guidLow);
    uint32 GetTypeReports(uint32 guidLow, uint8 type);
...
private:
    ...
    AnticheatPlayersDataMap _data;                        ///< Player data
};
